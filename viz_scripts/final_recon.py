...
def render(w2c, k, timestep_data, timestep_depth_data, cfg):
    with torch.no_grad():
        ...
        im, _, depth, = Renderer(raster_settings=white_bg_cam)(**timestep_data) # _, _ = Renderer(raster_settings=white_bg_cam)(**timestep_data)
        depth_sil, _, _, = Renderer(raster_settings=cam)(**timestep_depth_data) #_, _ = Renderer(raster_settings=cam)(**timestep_depth_data)
